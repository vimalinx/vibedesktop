...
describe("ConfigStore — icon field", () => {
  ...
  it("drops experimental and unknown fields from legacy records", async () => {
    const legacyControlKey = ["cloud", "ControlEnabled"].join("");
    const legacy = {
      version: 1,
      apps: [
        {
    ...
    expect(legacyControlKey in loaded).toBe(false);
  });
});
