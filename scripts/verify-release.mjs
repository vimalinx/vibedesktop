...
try {
  ...
  process.stdout.write("Verified: public allowlist, gates, signed assets, checksums, three Agent Skill roots, vibed health, app clone/build, app HTTP health, and authenticated app-to-vibed integration.\n");
} finally {
  if (keep) {
