    ...
    <Dialog title={t.dialogs.addAppTitle} t={t} onClose={onClose}>
      ...
      <label>
        ...
        <div className="inline-field">
          ...
          {/* Reading a site is a server-side fetch, so it has no counterpart in
              the browser-only trial; manual entry still adds the app. */}
          {urlMetadata ? <button onClick={resolve}>{t.dialogs.readSite}</button> : null}
        </div>
      </label>
      <label>
        {t.dialogs.name}
